...
class TestOutputMetrics(unittest.TestCase):
    ...
    def test_build_metrics_collects_deterministic_counts(self):
        ...
        self.assertEqual(metrics["graph"]["node_count"], 3)
        self.assertEqual(metrics["graph"]["edge_count"], 2)
    ...
    def test_compare_metrics_fails_when_topology_loop_area_changes(self):
        ...
        with self.assertRaises(SystemExit):
            compare_metrics(self.snapshot_path, self.outputs_dir)
            ...
            json.dump(
                {
                    "nodes": [{"id": 0}, {"id": 1}, {"id": 2}],
                    "edges": [{"id": 1}, {"id": 2}],
                    "loops": [{"id": 0, "area": 100.0}, {"id": 1, "area": 100.0}],
                },
                handle,
                indent=2,
            )
